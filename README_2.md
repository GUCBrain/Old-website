...
### Live demo http://gdg-x.github.io/

#### Automated version with Grunt <https://github.com/gdg-x/-grunt>
...
### Quick-start guide
1. [Fork](https://github.com/gdg-x/fork) this repo
2. Clone locally
...
Learn more about Sass development from [documentation](https://github.com/gdg-x/wiki/Sass-development).
...
Learn more about available optimization options from [documentation](https://github.com/gdg-x/wiki/Resources-optimizations).

### Documentation
Quick-start guide is not enough? Checkout [full documentation](https://github.com/gdg-x/wiki).
...
| [GDG DevFest The Netherlands](http://www.devfest.nl/) | [DevFest Centro-Oeste 2014](http://www.devfestcentrooeste.com.br/) | [Android DevFest Space Coast](http://gdg-space-coast.github.io/) |
| [DevFest SP 2014](http://sp.devfest.com.br/) | [DevFest in Baroda](http://devfest.gdgbaroda.com/) | [GDG Hi Pic (France)](http://maximemularz.github.io/) |
| [GDG DevFest Córdoba 2014](http://gdgcordoba.github.io/) | [GDG DevFest Düsseldorf 2014](http://www.gdg-dus.de/DevFest2014/) | [GDG Makerere DevFest 2014](http://gdgmakerere.github.io/) |
...
| [DevFest Chennai 2014](http://devfest.gdgchennai.com/) | [GDG DevFest Bari](http://gdgbari.github.io/) | [GDG DevFest Ahmedabad](http://devfest.gdgahmedabad.com/) |
...
### License
Project is published under the [MIT license](https://github.com/gdg-x/blob/master/LICENSE.txt). Feel free to clone and modify repo as you want, but don't forget to add reference to authors :)
